...
$prevarticle = esc_html(get_theme_mod( 'blogson_single_post_previous_article_text', esc_html__('Previous Article','blogson')));
$nextarticle = esc_html(get_theme_mod( 'blogson_single_post_next_article_text', esc_html__('Next Article','blogson')));
														...
														the_post_navigation(
														    array(
														        ...
														        'next_text' => '<span class="meta-nav" aria-hidden="true">'. $nextarticle .'</span> ' .
																				...
																				'<h5 class="post-title">%title</h5>',
														        'screen_reader_text' => esc_html__('Posts navigation', 'blogson')
														    )
														);
