...
if( ! class_exists('BlogSon_Top_Categories_Widget')) :

class BlogSon_Top_Categories_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'blogson_top_categories_widget', // Base ID
			esc_html__( 'BlogSon: Top Categories Widget', 'blogson' ), // Name
			array( 'description' => esc_html__( 'Adds list of top categories to the left or right sidebar in BlogSon WordPress theme. ', 'blogson'), ) // Args
		);		     
	}
...
if( ! function_exists('blogson_register_top_categories_widget')) :
// register widget
function blogson_register_top_categories_widget() {
    register_widget( 'BlogSon_Top_Categories_Widget' );
}
endif;

add_action( 'widgets_init', 'blogson_register_top_categories_widget' );
